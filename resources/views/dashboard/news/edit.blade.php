        ...
        <div id="layoutSidenav_content">
            ...
            <div class="col-lg-8">
                <form method="post" action="/dashboard/news/{{ $news->slug }}" class="mb-5" enctype="multipart/form-data">
                  ...
                  is-invalid
              @enderror"
                            id="title" name="title" required autofocus value="{{ old('title', $news->title) }}">
                        @error('title')
          ...
          @enderror" id="slug"
                    ...
                    <div class="mb-3">
                        ...
                        <input id="body" type="hidden" name="body" required
                            value="{{ old('body', $news->body) }}">
                        <trix-editor input="body"></trix-editor>
                    </div>
                    <a href="/dashboard/news" class="btn btn-danger">
                        <i class="bi bi-arrow-left"></i> Back
                    </a>
                    <button type="submit" class="btn btn-primary"><i class="bi bi-send"></i> Update news</button>
                </form>
            </div>
